...
<script>
  export default {
    data: () => ({
      ...
      question: 0,
      questions: [
      {title: 'How were the remains actually re-buried?', text: 'By 1901, there was a law dictating that cemeteries were supposed to submit paperwork in order to rebury people. City hall does not have any such records of reinterment. Either these records were lost over time, the remains were not, in fact, reburied and only the headstones were moved, the remains were moved in a non-professional fashion, or the paperwork wasn’t submitted but the remains were moved properly. Which hypothesis seems most likely to you? How would you verify this hypothesis?'},
